  ...
  return (
    <div>
      ...
      <Video
        ...
        alt="Match SoC"
        description="The app consists of a frontend written in React and a backend written in Node.js, Express and PostgreSQL. The aim was to improve the relationship between bootcampers and mentors by guaging how closely linked the two parties are. The application does this by comparing both parties based on their industry and interests."
